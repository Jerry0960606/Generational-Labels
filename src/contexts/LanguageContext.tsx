...
export const translations: Translations = {
  ...
  q1o2: { en: "Ask them to explain it and why it's popular.", zh: '直接請他們解釋那是什摩意思，還有為什麼會流行。' },
  ...
  resultBridgeWatchOut: { en: 'Blind Spots: "The Middle Man" often gets exhausted. Don\'t forget to build your own direct bridges and share your own needs.', zh: '潛在盲點：「中間人」往往會精確力竭。別忘了也要建立屬於自己的直接連結並分享自己的需求。' },
  ...
  // Generations (Shortened titles/desc for brevity in translations)
