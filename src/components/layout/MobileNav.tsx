...
import { Home, Compass, Heart, BookOpen, MessageCircle, Lightbulb, HelpCircle } from 'lucide-react';
...
export const MobileNav: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: t('actionGuide'), path: '/action-guide', icon: Lightbulb },
    { name: t('bridgeQuiz'), path: '/quiz', icon: HelpCircle },
  ];
